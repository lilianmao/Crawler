.class public Lcn/jpush/android/ui/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v6, Lcn/jpush/android/ui/h;->z:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;ILjava/util/List;)V
    ...
    iput-object v0, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;

    iput-object p1, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Lcn/jpush/android/ui/h;->getItem(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcn/jpush/android/a/d;

    iget-object v1, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;

    const/high16 v2, 0x40a00000

    invoke-static {v1, v2}, Lcn/jpush/android/c/a;->a(Landroid/content/Context;F)I

    move-result v1

    new-instance p2, Landroid/widget/FrameLayout;

    iget-object v2, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;

    invoke-direct {p2, v2}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/widget/LinearLayout;

    iget-object v3, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;
    ...
    sget-object v3, Lcn/jpush/android/ui/h;->z:[Ljava/lang/String;
    ...
    iget-object v4, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;
    ...
    check-cast v1, Lcn/jpush/android/a/h;

    iget-object v1, v1, Lcn/jpush/android/a/h;->ac:Lcn/jpush/android/a/k;

    iget-object v1, v1, Lcn/jpush/android/a/k;->l:Ljava/lang/String;
    ...
    invoke-static {v1, v5}, Lcn/jpush/android/c/a;->a(Landroid/content/Context;F)I
    ...
    iget-object v5, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;
    ...
    iget-object v5, v0, Lcn/jpush/android/a/d;->c:Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Lcn/jpush/android/c/a;->a(Landroid/content/Context;F)I
    ...
    iget-object v0, p0, Lcn/jpush/android/ui/h;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v1}, Lcn/jpush/android/c/a;->a(Landroid/content/Context;F)I
    ...
    sget-object v7, Lcn/jpush/android/ui/h;->z:[Ljava/lang/String;
    ...
    const-class v7, Lcn/jpush/android/ui/h;
    ...
    invoke-static {v1, v4}, Lcn/jpush/android/c/a;->a(Landroid/content/Context;F)I
    ...
    invoke-static {v1, v3}, Lcn/jpush/android/c/a;->a(Landroid/content/Context;F)I
